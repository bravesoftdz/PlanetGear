...
Type
  ...
  TOutput = record
    z1, z2_1,z2_2, z3: integer; // Чмсла зубьев.
    ...
    da_1, da_2_1,da_2_2, da_3: extended; // Диаметр вершин [мм].
    d_1, d_2_1, d_2_2, d_3: extended; // Делительный диаметр [мм].
    ...
    Sigma_F_1, Sigma_F_2_1,Sigma_F_2_2, Sigma_F_3: extended; // Рабочее изгибное напряжение [МПа].
